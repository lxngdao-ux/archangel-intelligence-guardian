...
Source of truth: `GUARDIAN_ARCHITECTURE.md` Design Principle #6 (redaction by default) and Architecture Principle #7 (PII redacted before leaving the platform). This document makes those principles operational.
